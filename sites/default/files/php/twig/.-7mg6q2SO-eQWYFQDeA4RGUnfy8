...
class __TwigTemplate_aa94fd0b270414cd63e0c5ed8cd76f3e extends Template
{
    private $source;
    private $macros = [];
...
($context["menu_level"] ?? null) == 0) && twig_get_attribute($this->env, $this->source, $context["item"], "is_expanded", [], "any", false, false, true, 49))) {
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/tara/templates/navigation/menu--main.html.twig", "C:\\xamppp\\htdocs\\drupal\\themes\\contrib\\tara\\templates\\navigation\\menu--main.html.twig");
    }
