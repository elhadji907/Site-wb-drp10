...
namespace Drupal\block_classes\Form;
...
/**
 * Form for Block Classes Settings.
 */
class BlockClassesSettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'block_classes_admin_settings';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $config = $this->config('block_classes.settings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($previous_default_case != $default_case) {
      ...
      $this->messenger->addStatus($this->t('Now you are using @default_case@ as a default case. If you want to convert all classes stored, feel free run the <a href="/admin/config/content/block-classes/bulk-operations">Bulk Update</a> to convert all to @default_case@', [
